      ...
      <div className="my-3">
          <div className='d-flex justify-content-between px-3 my-2'>
              <div className="d-flex justify-content-start align-items-center">
                  <div className="p-2 m-1" style={{backgroundColor :'purple'}}></div>
          ...
          <div className='d-flex justify-content-between px-3 my-2'>
              <div className="d-flex justify-content-start align-items-center">
                  <div className="p-2 m-1 bg-" style={{backgroundColor :'blue'}}></div>
          ...
          <div className='d-flex justify-content-between px-3 my-2'>
              <div className="d-flex justify-content-start align-items-center">
                  <div className="p-2 m-1 " style={{backgroundColor :'violet'}}></div>
